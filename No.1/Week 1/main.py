...
def analyze_logs(log_lines):
    error_keywords = [
        '[ERROR]', '[CRITICAL]', 'Exception:', 'Traceback (most recent call last):',
        'mission failure', 'shutdown', 'connection lost', 'unstable', 'explosion'
    ]
    return [line.strip() for line in log_lines if any(keyword in line for keyword in error_keywords)]
